      ...
      >
        <div className="grid gap-0 md:grid-cols-[1.1fr,1fr]">
          <div className="relative hidden bg-[var(--theme-primary-hex)]/90 p-10 text-white md:flex md:flex-col">
            ...
            <div className="absolute -top-20 left-16 h-64 w-64 rounded-full blur-3xl"
              style={{ background: "rgba(255,255,255,0.25)" }}
            />
            <div className="absolute bottom-10 right-10 h-32 w-32 rounded-full blur-3xl"
            ...
            <div className="relative flex h-full flex-col justify-between">
              <div>
                ...
                <h1 className="mt-6 text-3xl font-semibold leading-tight">Create your Empath space</h1>
                <p className="mt-3 max-w-sm text-sm text-white/80">
                  Build secure, nurturing client relationships with thoughtful tools designed for therapists and caregivers.
                </p>
              </div>
              <div className="space-y-2 rounded-2xl border border-white/10 bg-white/10 p-4 text-sm backdrop-blur-md">
                <p className="font-semibold text-white">What you&apos;ll love</p>
            ...
            <div className="mx-auto w-full max-w-md space-y-8">
              <div className="space-y-3 text-center md:text-left">
                ...
                <p className="text-sm text-slate-500">
                  Share a few details to start organizing meaningful care journeys.
                </p>
              </div>
              <SignUpForm />
            </div>
