      ...
      >
        <div className="grid gap-0 md:grid-cols-[1fr,1.2fr]">
          <div className="relative hidden bg-[var(--theme-primary-hex)]/90 p-10 text-white md:flex md:flex-col">
            ...
            />
            <div
              className="absolute bottom-8 right-8 h-32 w-32 rounded-full blur-3xl"
            ...
            <div className="relative flex h-full flex-col justify-between">
              <div>
                ...
                <h1 className="mt-6 text-3xl font-semibold leading-tight">
                  Welcome back to Empath
                </h1>
                <p className="mt-3 max-w-sm text-sm text-white/80">
                  Reconnect with your clients and keep every relationship moving
                  forward. Sign in to access your dashboard and today&apos;s
                  agenda.
                </p>
              </div>
              <div className="space-y-2 rounded-2xl border border-white/10 bg-white/10 p-4 text-sm backdrop-blur-md">
                ...
                <p className="text-white/70">
                  A slow morning with mindful check-ins nurtures every session.
                  The Empath suite keeps your day organized with warmth.
                </p>
              </div>
            </div>
          </div>
